...
consumer_key="RvdpfqhFhu4BxCJVgl3m0XKWW"
consumer_secret="dcSA4cSFBdYrdN9qHHsTLaVGUAFgwoKWCB4ZxH69mVB6rciRk3"
access_token="2212538454-hESQnPaBVSOfMA5nLpLc7GYRFveeKEeVbwcX7F7"
access_token_secret="IK5S6e3cHF92dvgThnG5mhmK3nzon3F0fe0O25D6eaKUd"


AUTH = twitter.oauth.OAuth(access_token, access_token_secret, consumer_key, consumer_secret)
TWITTER_API = twitter.Twitter(auth=AUTH)

csvfile = open('BBCMusicAwards.monday.csv', 'w')
